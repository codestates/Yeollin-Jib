...
### 기획의도
1. 환경문제 개선
충분히 사용가능한 물품 나눔으로 인한 폐기물 배출 감소 효과
2. 공동체 의식 강화
바쁜 현대 생활에 사라진 이웃간의 소통 활성화
3. 사용자 편의성 개선
나눔활동에 집중 된 커뮤니티로 게시글 기한 지정 및 자동 마감처리
 
 
## ⚙️ 사용 스택
<img width="816" alt="기술 스택" src="https://user-images.githubusercontent.com/85698976/141467551-08acdb82-ec53-4d55-93a1-18efeeae6847.png">
...
* Works : Post, Post_Storage, Post_category, JWT, 검색기능, 무한 스크롤, Endpoint(전체 경로구현 및 담당), 배포(자동화 및 https 구현), 카카오 소셜 로그인 구현
