...
commentRouter.post("/:id", accessToken_1.default, commentcontroller.post_c);
commentRouter.patch("/:id", accessToken_1.default, commentcontroller.patch_c);
commentRouter.delete("/:id", accessToken_1.default, commentcontroller.delete_c);
