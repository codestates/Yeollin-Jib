...
// 댓글 수정
commentRouter.patch("/:commetId", accessToken_1.default, commentcontroller.patch_c);
// 댓글 삭제
commentRouter.delete("/:commetId", accessToken_1.default, commentcontroller.delete_c);
