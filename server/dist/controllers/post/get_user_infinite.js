...
const get_user_infinite = (req, res) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        const id = req.cookies.id; //유저아이디
        const pageNum = req.params; // page Number
        let offset = 0;
        if (pageNum > 1) {
            offset = 8 * (pageNum - 1);
        }
...
exports.default = get_user_infinite;
//# sourceMappingURL=get_user_infinite.js.map